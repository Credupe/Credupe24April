            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="overflow-x-auto rounded-xl border border-border">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {bankRates.map((b) => (
                      <tr key={b.bank} className="odd:bg-background even:bg-muted/30">
                        ...
                        <td className="px-4 py-3 text-right">
                          <Link to="/login" data-testid={`apply-now-${b.bank.toLowerCase().replace(/\s+/g, '-')}`} className="inline-flex items-center px-3 py-1.5 rounded-lg bg-primary text-primary-foreground text-xs font-semibold hover:opacity-90 transition-opacity whitespace-nowrap">
                            Apply Now
                          </Link>
                        </td>
                      </tr>
